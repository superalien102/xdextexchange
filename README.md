...
[![Follow on Twitter](https://img.shields.io/twitter/follow/JumperExchange.svg?label=follow+exchange.x-decentralized.com)](https://twitter.com/JumperExchange)

</div>

# exchange.x-decentralized.com

Lerna Monorepo for all exchange.x-decentralized.com related things
...
This is the exchange.x-decentralized.com page that gets deployed to `develop.exchange.x-decentralized.com`, `staging.exchange.x-decentralized.com` and `exchange.x-decentralized.com`. This is a vite.js app
